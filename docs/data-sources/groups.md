...
resource "ad_group_membership" "service_to_admin" {
  ...
  members  = [data.ad_groups.service_groups.groups[index(data.ad_groups.service_groups.groups[*].sam_acgroup_count_name, replace(each.key, "Admin", "Service"))].distinguished_name]
}
```
